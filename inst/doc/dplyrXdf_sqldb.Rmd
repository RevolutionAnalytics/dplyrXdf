...
Going the other way is also possible: starting from a database table, dplyrXdf can import the data to Xdf format. This is done via `compute` if you want to create a temporary Xdf file (which will be deleted after you quit R), or `as_xdf` if you want a permanent Xdf file.
