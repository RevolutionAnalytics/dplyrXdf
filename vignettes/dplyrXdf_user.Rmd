...
In general, you never need to create a `tbl_xdf` manually. The exception is if you want to create a `tbl_xdf` from a non-Xdf data source. In that case you can do the following, which will transparently import the data into an Xdf file:
