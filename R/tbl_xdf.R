...
#'
#' @param path Directory where the files are located. Defaults to the R temporary directory.
#' @param ignore.case Logical. Should filename matching be case-insensitive?
#' @details
