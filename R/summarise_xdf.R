...
#    if(.method %in% 3:5 && !is.null(rxArgs))
#    {
#        warning(".rxArgs not supported for method ", .method, call.=FALSE)
#        rxArgs <- NULL
#    }
