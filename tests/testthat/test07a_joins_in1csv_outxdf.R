...
test_that("csv to xdf joining works", {
    ...
    expect(class(right_join(txt1, xdf2, .outFile="test7a.xdf")) == "RxXdfData", "not RxXdfData")
    expect(class(inner_join(txt1, xdf2, .outFile="test7a.xdf")) == "RxXdfData", "not RxXdfData")
    expect(class(full_join(txt1, xdf2, .outFile="test7a.xdf")) == "RxXdfData", "not RxXdfData")
    ...
    expect(class(inner_join(txt1, xdf2, by=c("c"="d"), .outFile="test7a.xdf")) == "RxXdfData", "not RxXdfData")
})


test_that("csv to data frame joining works", {
    expect(class(left_join(txt1, df2, .outFile="test7a.xdf")) == "RxXdfData", "not RxXdfData")
    expect(class(right_join(txt1, df2, .outFile="test7a.xdf")) == "RxXdfData", "not RxXdfData")
    expect(class(inner_join(txt1, df2, .outFile="test7a.xdf")) == "RxXdfData", "not RxXdfData")
    expect(class(full_join(txt1, df2, .outFile="test7a.xdf")) == "RxXdfData", "not RxXdfData")
    ...
    expect(class(inner_join(txt1, df2, by=c("c"="d"), .outFile="test7a.xdf")) == "RxXdfData", "not RxXdfData")
})


test_that("csv to csv joining works", {
    expect(class(left_join(txt1, txt2, .outFile="test7a.xdf")) == "RxXdfData", "not RxXdfData")
    expect(class(right_join(txt1, txt2, .outFile="test7a.xdf")) == "RxXdfData", "not RxXdfData")
    expect(class(inner_join(txt1, txt2, .outFile="test7a.xdf")) == "RxXdfData", "not RxXdfData")
    expect(class(full_join(txt1, txt2, .outFile="test7a.xdf")) == "RxXdfData", "not RxXdfData")
    ...
    expect(class(inner_join(txt1, txt2, by=c("c"="d"), .outFile="test7a.xdf")) == "RxXdfData", "not RxXdfData")
})
