...
The package is available for download from Github, at [`https://github.com/Hong-Revo/dplyrXdf`](https://github.com/Hong-Revo/dplyrXdf). If you have the devtools package installed, you can download and install it from within R using the command `devtools::install_github("Hong-Revo/dplyrXdf")`.
